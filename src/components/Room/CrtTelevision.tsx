 ...
 */
function PanelKey({ id, label, onPress, hit, children }: PanelKeyProps) {
  ...
  return (
    ...
    >
      <rect
        ...
        x={hit.x - HIT_PADDING}
        y={hit.y - HIT_PADDING}
        width={hit.width + HIT_PADDING * 2}
        height={hit.height + HIT_PADDING * 2}
        fill="transparent"
      />
      {children}
    </g>
 ...
 * drifting apart is the one way this can be wrong.
 */
...
export function CrtTelevision({
  ...
  return (
    <div className="crt-tv" data-power={power}>
      <svg
      ...
      >
        ...
        {/* floor shadow: wide ambient + tight dark contact line */}
        <ellipse
          cx="500"
          cy="790"
          rx="410"
